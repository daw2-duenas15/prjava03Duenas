package prjava03.duenas15; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.net.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava03Duenas15 extends Frame 
   ...
   public Prjava03Duenas15 () { 
      ...
      setTitle("nova finestra prjava03-Duenas15");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03Duenas15();  // Let the construct do the job 
   } 
